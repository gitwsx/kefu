<template>
  <div>
    <!--<div class="wel__header">-->
      <!--&lt;!&ndash;<div class="wel__info">&ndash;&gt;-->
        <!--&lt;!&ndash;<img :src="userInfo.avatar"&ndash;&gt;-->
             <!--&lt;!&ndash;alt=""&ndash;&gt;-->
             <!--&lt;!&ndash;class="wel__info-img">&ndash;&gt;-->
        <!--&lt;!&ndash;<div class="wel__info-content">&ndash;&gt;-->
          <!--&lt;!&ndash;<div class="wel__info-title">&ndash;&gt;-->
            <!--&lt;!&ndash;{{$t('wel.info')}}&ndash;&gt;-->
          <!--&lt;!&ndash;</div>&ndash;&gt;-->
          <!--&lt;!&ndash;<div class="wel__info-subtitle">&ndash;&gt;-->
            <!--&lt;!&ndash;{{$t('wel.dept')}}&ndash;&gt;-->
          <!--&lt;!&ndash;</div>&ndash;&gt;-->
        <!--&lt;!&ndash;</div>&ndash;&gt;-->
      <!--&lt;!&ndash;</div>&ndash;&gt;-->
      <!--&lt;!&ndash;<div class="wel__extra">&ndash;&gt;-->
        <!--&lt;!&ndash;<div class="wel__extra-item">&ndash;&gt;-->
          <!--&lt;!&ndash;<p class="wel__extra-title">&ndash;&gt;-->
            <!--&lt;!&ndash;{{ $t('wel.count')}}&ndash;&gt;-->
          <!--&lt;!&ndash;</p>&ndash;&gt;-->
          <!--&lt;!&ndash;<p class="wel__extra-subtitle">&ndash;&gt;-->
            <!--&lt;!&ndash;56&ndash;&gt;-->
          <!--&lt;!&ndash;</p>&ndash;&gt;-->
        <!--&lt;!&ndash;</div>&ndash;&gt;-->
        <!--&lt;!&ndash;<div class="wel__extra-item">&ndash;&gt;-->
          <!--&lt;!&ndash;<p class="wel__extra-title">&ndash;&gt;-->
            <!--&lt;!&ndash;{{ $t('wel.team')}}&ndash;&gt;-->
          <!--&lt;!&ndash;</p>&ndash;&gt;-->
          <!--&lt;!&ndash;<p class="wel__extra-subtitle">&ndash;&gt;-->
            <!--&lt;!&ndash;8 <span>/ 24</span>&ndash;&gt;-->
          <!--&lt;!&ndash;</p>&ndash;&gt;-->
        <!--&lt;!&ndash;</div>&ndash;&gt;-->
        <!--&lt;!&ndash;<div class="wel__extra-item">&ndash;&gt;-->
          <!--&lt;!&ndash;<p class="wel__extra-title">&ndash;&gt;-->

            <!--&lt;!&ndash;{{ $t('wel.project')}}&ndash;&gt;-->
          <!--&lt;!&ndash;</p>&ndash;&gt;-->
          <!--&lt;!&ndash;<p class="wel__extra-subtitle">&ndash;&gt;-->
            <!--&lt;!&ndash;2,223&ndash;&gt;-->
          <!--&lt;!&ndash;</p>&ndash;&gt;-->
